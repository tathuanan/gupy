...
"""
    copia_animais = animais_originais.copy()
    copia_falas_do_cantor = falas_do_cantor_originais.copy()
    copia_partes_do_corpo = partes_do_corpo_originais.copy()
    ### Variáveis - FIM ###
            ...
            while True:
                ...
                if opcao_secundaria in (1,2):
                    ...
                    while True:
                        ...
                        for animais in animais_originais:
                        ...
                        if escolha == -1:
                            break
                        elif escolha <= (len(animais_originais)):
